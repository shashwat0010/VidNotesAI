...
export default function Signup() {
  const { register, loginWithOAuth, isSupabase } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-500/10 blur-[130px] rounded-full pointer-events-none"></div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">
          ...
          <Link href="/login" className="font-medium text-indigo-400 hover:text-indigo-300 transition duration-150 underline underline-offset-4">
            Sign in here
          </Link>
        </p>
      </div>
